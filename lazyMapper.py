...
with open(input1, encoding='utf-8') as f:
    ...
    while(1):
        ...
        if line.__contains__("Version:"):
            ...
            if input2 == 2: diffName = "SmallCircle"
            if input2 == 3: diffName = "Custom ("+input3+")"
...
with open(title+"[lazyMapper"+diffName+"].osu", "w", encoding='utf-8') as file:
    ...
    templateSmallSquare = ["224,192,483,1,0,0:0:0:0:", "224,160,561,1,0,0:0:0:0:", "256,160,640,1,0,0:0:0:0:", "288,160,719,1,0,0:0:0:0:", "288,192,797,1,0,0:0:0:0:", "288,224,876,1,0,0:0:0:0:", "256,224,955,1,0,0:0:0:0:", "224,224,1033,1,0,0:0:0:0:"]
    hitOut = []
